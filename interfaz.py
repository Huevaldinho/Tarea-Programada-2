...
def escogido():
    escogio=opcion.get()
    print(escogio)
Radiobutton(root, text="1. San José", variable=opcion,value=1,command=seleccionar).pack()
Radiobutton(root, text="2. Alajuela", variable=opcion,value=2, command=seleccionar).pack()
Radiobutton(root, text="3. Cartago", variable=opcion,value=3, command=seleccionar).pack()   
Radiobutton(root, text="4. Cartago", variable=opcion,value=4, command=seleccionar).pack()   
Radiobutton(root, text="5. Guanacaste", variable=opcion,value=5, command=seleccionar).pack()   
Radiobutton(root, text="6. Puntarenas", variable=opcion,value=6, command=seleccionar).pack()   
Radiobutton(root, text="7. Limón.¿", variable=opcion,value=7, command=seleccionar).pack()   
Radiobutton(root, text="8. Nacionalizado o naturalizado", variable=opcion,value=8, command=seleccionar).pack()   
Radiobutton(root, text="9. Caso especial", variable=opcion,value=9,command=seleccionar).pack()   
